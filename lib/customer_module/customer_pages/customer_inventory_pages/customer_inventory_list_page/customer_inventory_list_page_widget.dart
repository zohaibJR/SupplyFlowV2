                                    ...
                                    child: StreamBuilder<List<InventoryRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemCount: listViewInventoryRecordList
                                              .length,
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              LinearPercentIndicator(
                                                                                percent: valueOrDefault<double>(
                                                                                  listViewInventoryRecord.productCurrentAmount.toDouble() / listViewInventoryRecord.productMaxLimit.toDouble(),
                                                                                  0.0,
                                                                                ),
                                                                                width: 210.0,
                                                                                lineHeight: 20.0,
                                                                                ...
                                                                                progressColor: Color(0xFF487596),
                                                                                backgroundColor: FlutterFlowTheme.of(context).accent4,
                                                                                center: Text(
                                                                                  '${((listViewInventoryRecord.productCurrentAmount.toDouble() / listViewInventoryRecord.productMaxLimit.toDouble()) * 100).toString()} %',
                                                                      ...
                                                                      await OrdersRecord
                                                                        ...
                                                                        ...createOrdersRecordData(
                                                                          supplierID: _model
                                                                              ...
                                                                              ?.reference,
                                                                          productName:
                                                                              listViewInventoryRecord.productName,
                                                                          productQuantity:
                                                                              listViewInventoryRecord.productMaxLimit,
                                                                          isJobCompleted:
                                                                              false,
                                                                          isJobActive:
                                                                              false,
                                                                          customerID:
                                                                              customerInventoryListPageCustomerRecord?.reference,
                                                                          isJobInProcess:
                                                                              false,
                                                                        ),
                                                                        ...mapToFirestore(
